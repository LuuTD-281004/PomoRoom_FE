        ...
        <div className="w-6xl mx-auto border-t-8 border-[#567CB1] bg-[#EAF6FF] rounded-2xl p-8 relative">
          <div className="grid grid-cols-12 gap-8 items-start">
            ...
            <div className="col-span-5 flex flex-col items-center">
              ...
              <div className="w-full mt-2 px-6 pb-6">
                ...
                <div className="flex justify-center gap-15 text-center">
                  <div>
                    <div className="text-5xl font-extrabold text-[#0C1A57]">{hours}</div>
                    <div className="text-xs text-[#0C1A57] mt-2 flex flex-col gap-2 items-center"><svg width="30" height="30" viewBox="0 0 55 55" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    </svg><span>GIỜ</span></div>
                  </div>

                  <div>
                    <div className="text-5xl font-extrabold text-[#0C1A57]">{stars}</div>
                    <div className="text-xs text-[#0C1A57] mt-2 flex flex-col gap-2 items-center"><svg width="30" height="30" viewBox="0 0 55 55" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    </svg><span>SAO</span></div>
                  </div>

                  <div>
                    <div className="text-5xl font-extrabold text-[#0C1A57]">{rank}</div>
                    <div className="text-xs text-[#0C1A57] mt-2 flex flex-col gap-2 items-center"><svg width="30" height="30" viewBox="0 0 61 58" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="col-span-7">
              <h2 className="text-xl font-semibold text-[#0C1A57] mb-5">Hồ sơ của tôi</h2>
              <div className="space-y-4">
                ...
                <div className="text-right mt-6">
                  {!editing ? (
                    <Button onClick={() => setEditing(true)} size="small" className="bg-white text-[#0C1A57]">
                      Edit
                    </Button>
                  ) : (
