    ...
    return (
        <div className="flex h-screen bg-blue-100">
            ...
            <div className="fixed flex items-center gap-4 top-40 p-4 right-5 ">
                ...
                <div onClick={() => setShowStarExchange(true)} className="text-xs cursor-pointer text-center h-fit font-medium text-[#0C1A57]">
                    <svg className="mx-auto" width="51" height="51" viewBox="0 0 51 51" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <path d="M32.0759 30.4176L27.8608 29.805L25.9765 25.985C25.925 25.8804 25.8403 25.7957 25.7358 25.7442C25.4734 25.6148 25.1547 25.7227 25.0235 25.985L23.1393 29.805L18.9241 30.4176C18.8079 30.4342 18.7017 30.489 18.6203 30.572C18.522 30.6731 18.4678 30.809 18.4697 30.9501C18.4715 31.0911 18.5293 31.2256 18.6303 31.324L21.68 34.2974L20.9595 38.4959C20.9426 38.5936 20.9534 38.694 20.9907 38.7859C21.028 38.8777 21.0902 38.9572 21.1704 39.0155C21.2506 39.0737 21.3455 39.1084 21.4444 39.1154C21.5433 39.1224 21.6421 39.1017 21.7298 39.0554L25.5 37.0732L29.2702 39.0554C29.3732 39.1102 29.4927 39.1284 29.6072 39.1085C29.8961 39.0587 30.0903 38.7848 30.0405 38.4959L29.32 34.2974L32.3697 31.324C32.4527 31.2427 32.5075 31.1364 32.5241 31.0202C32.569 30.7297 32.3664 30.4607 32.0759 30.4176Z" fill="#0234A7" />
                    </svg>
                    Trạm đổi sao
                </div>
                <div>
                    <svg width="35" height="35" viewBox="0 0 35 35" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M17.5 2.1875C9.04395 2.1875 2.1875 9.04395 2.1875 17.5C2.1875 25.9561 9.04395 32.8125 17.5 32.8125C25.9561 32.8125 32.8125 25.9561 32.8125 17.5C32.8125 9.04395 25.9561 2.1875 17.5 2.1875ZM17.5 26.3867C16.7446 26.3867 16.1328 25.7749 16.1328 25.0195C16.1328 24.2642 16.7446 23.6523 17.5 23.6523C18.2554 23.6523 18.8672 24.2642 18.8672 25.0195C18.8672 25.7749 18.2554 26.3867 17.5 26.3867ZM19.6499 18.8843C19.3404 19.0038 19.074 19.2138 18.8856 19.487C18.6972 19.7601 18.5955 20.0837 18.5938 20.4155V21.1914C18.5938 21.3418 18.4707 21.4648 18.3203 21.4648H16.6797C16.5293 21.4648 16.4062 21.3418 16.4062 21.1914V20.4565C16.4062 19.667 16.6353 18.8877 17.0864 18.2383C17.5273 17.6025 18.1426 17.1172 18.8672 16.8403C20.0293 16.3926 20.7812 15.4185 20.7812 14.3555C20.7812 12.8481 19.3081 11.6211 17.5 11.6211C15.6919 11.6211 14.2188 12.8481 14.2188 14.3555V14.6152C14.2188 14.7656 14.0957 14.8887 13.9453 14.8887H12.3047C12.1543 14.8887 12.0312 14.7656 12.0312 14.6152V14.3555C12.0312 13.0122 12.6191 11.7578 13.6855 10.8247C14.7109 9.92578 16.0645 9.43359 17.5 9.43359C18.9355 9.43359 20.2891 9.9292 21.3145 10.8247C22.3809 11.7578 22.9688 13.0122 22.9688 14.3555C22.9688 16.3311 21.6665 18.1084 19.6499 18.8843Z" fill="white" />
                    </svg>
                </div>
            </div>
            ...
            <StarExchangeModal isOpen={showStarExchange} onClose={() => setShowStarExchange(false)} />
        </div>
    )
}
